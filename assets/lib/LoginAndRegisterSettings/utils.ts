...
export function fieldKinds(isPrimary:boolean): {kind:"NAME"|"TEXT"|"CHECKBOX", onlyOne:boolean}[]{
  const kinds:{kind:"NAME"|"TEXT"|"CHECKBOX", onlyOne:boolean}[] = [
    {kind:"NAME",onlyOne:true},
  ]
  if ( !isPrimary ){
    kinds.push({kind:"TEXT",onlyOne:false},{kind: "CHECKBOX", onlyOne:false}) 
  }

  return kinds
}

export function genId():string { // Public Domain/MIT
