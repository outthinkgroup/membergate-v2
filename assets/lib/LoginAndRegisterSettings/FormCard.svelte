...
<dialog
  ...
  class="border-slate-200 border p-0 bg-slate-50 w-[85vw]  h-[75vh] overflow-y-auto rounded-lg max-w-[950px]"
>
...
<style>
  :global(body.auto-fold:not(.folded) dialog) {
    margin-left: 240px; /* admin side bar is 160 + wp sidbar margin is 20 + our app margin  32 + our app padding is 28 */
  }
</style>
